...
// Auto-generated from amazon/foxxy.js
...
window.__foxxy_open_listing = async function open_listing({ n }) {
...
window.__foxxy_sort = async function sort({ method }) {
...
window.__foxxy_add_to_cart = async function add_to_cart({ n } = {}) {
...
window.__foxxy_buy_now = async function buy_now() {
...
window.__foxxy_go_to_checkout = async function go_to_checkout() {
...
window.__foxxy_click_proceed_checkout = async function click_proceed_checkout() {
...
window.__foxxy_get_price = async function get_price() {
